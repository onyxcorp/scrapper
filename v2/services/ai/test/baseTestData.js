var productList = [
    ...
    { type: 'Barra Proteina', supplier: 'Pró Premium Line', title: 'Choko Crunch Protein (12 unid) Pró Premium Line - 30% OFF'},
    ...
    { type: 'Barra Proteina', supplier: 'Pró Premium Line', title: 'Choko Crunch Protein (*UNIDADE*) Pró Premium Line'},
    { type: 'Barra Proteina', supplier: 'Nutrilatina', title: 'Protein Bar (24 unid x 46g) Nutrilatina Age *Grátis 2ª Caixa*'},
    { type: 'Barra Proteina', supplier: 'Nutrilatina', title: 'Protein Bar (24 unid x 46g) Nutrilatina Age'},
    { type: 'Barra Proteina', supplier: 'Nutrilatina', title: 'Protein Bar (24 unid x 30g) Nutrilatina Age'},
    { type: 'Barra Proteina', supplier: 'Nutrilatina', title: 'Protein Bar (Unidade - 46g) Nutrilatina Age'},
    ...
    { type: 'Barra Proteina', supplier: 'Pró Premium Line', title: 'Wafer Protein Bar (45g/12unid) Pró Premium Line'},
    { type: 'Barra Proteina', supplier: 'Probiótica', title: 'Whey Bar (24unid) Probiótica'},
    { type: 'Carboidrato', supplier: 'Probiótica', title: 'Waxy Maize (1.4kg) Probiótica - 10% OFF'},
    { type: 'Carboidrato', supplier: 'Body Action', title: 'Waxy Maize Pure (900g) Body Action'},
    { type: 'Carboidrato', supplier: 'Max Titanium', title: 'Waxy Maize (4kg) Max Titanium'},
    { type: 'Carboidrato', supplier: 'Nutrilatina', title: 'Waxy Maize (900g) Nutrilatina Age'},
    { type: 'Carboidrato', supplier: 'New Millen', title: 'Waxy Maize Pós Treino (1000g) New Millen'},
    { type: 'Carboidrato', supplier: 'Integral Médica', title: 'Waxy Maize (1,5kg) Integral Médica'},
    { type: 'Carboidrato', supplier: 'Probiótica', title: 'Waxy Maize (1.4kg) Probiótica - 10% OFF'},
    ...
    { type: 'Creatina', supplier: 'Nutrilatina', title: 'Creatina (120caps) Nutrilatina Age'},
